export default function Footer(){
    ...
    return (
        <>
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between px-[3rem] py-[3rem] xl:mt-[20.313rem] mt-[2.313rem] mb-[1.5rem] rounded-[2.5rem] bg-my-blueHeader select-none  ">        
